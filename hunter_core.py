...
AWAKENING_CONFIG = {
    5: {
        ...
        "quote": '"Welcome, Hunter."',
        "color": 0xFF4A90D9,
        "duration": 6.0,
        "effect": "system_boot",
        "tip": "Press [N] to choose your abilities",
        "sound_intensity": 1,
    },
    10: {
        "name": "FIRST EVOLUTION",
        "subtitle": "Your power manifests",
    ...
    15: {
        "name": "ADAPTATION",
        "subtitle": "The body adapts to power",
        "quote": '"Pain forges strength."',
        "color": 0xFF00FFAA,
        "duration": 5.0,
        "effect": "adaptation",
        "sound_intensity": 1,
    ...
    20: {
        "name": "RESONANCE",
        "subtitle": "Energy flows freely",
        "quote": '"Do you feel the power within you?"',
        "color": 0xFF00FFFF,
        "duration": 5.5,
        "effect": "resonance",
        "sound_intensity": 2,
    ...
    25: {
        "name": "MANIFESTATION",
        "subtitle": "Your power takes form",
        "quote": '"You are no longer a novice."',
        "color": 0xFF00DDFF,
        "duration": 5.5,
    ...
    30: {
        ...
        "subtitle": "Access to Hunter Terminal",
        "quote": '"The System expands for you."',
        "color": 0xFF0088FF,
        "duration": 8.0,
        "effect": "terminal_unlock",
        "tip": "The [TERMINAL] is now available",
        "sound_intensity": 3,
    },
    40: {
        "name": "CONSOLIDATION",
        "subtitle": "Power stabilizes",
        "quote": '"Growth never stops."',
        "color": 0xFF0066FF,
        "duration": 5.0,
    ...
    50: {
        "name": "HALFWAY",
        "subtitle": "You have walked half the path",
        "quote": '"But the real journey begins now."',
        "color": 0xFFAA00FF,
        "duration": 6.0,
        "effect": "halfway",
        "sound_intensity": 2,
    ...
    60: {
        "name": "MATURATION",
        "subtitle": "Your power matures",
        "quote": '"The weak begin to fear you."',
        "color": 0xFFBB00FF,
        "duration": 5.5,
        "effect": "maturation",
        "sound_intensity": 2,
    ...
    70: {
        "name": "ADVANCED AWAKENING",
        "subtitle": "Beyond ordinary limits",
        "quote": '"You see things others cannot see."',
        "color": 0xFFFF6600,
        "duration": 6.0,
    ...
    90: {
        "name": "LEGENDARY THRESHOLD",
        "subtitle": "Few make it this far",
        "quote": '"You are worthy of your title."',
        "color": 0xFFFF0000,
        "duration": 7.0,
    ...
    110: {
        "name": "TRANSCENDENCE",
        "subtitle": "Beyond every known limit",
        "quote": '"Limits exist only to be broken."',
        "color": 0xFFFFE066,
        "duration": 7.0,
    ...
    120: {
        "name": "ASCENSION",
        "subtitle": "You are no longer human",
        "quote": '"I alone... advance."',
        "color": 0xFFFF00FF,
        "duration": 9.0,
        "effect": "ascension",
        "sound_intensity": 5,
